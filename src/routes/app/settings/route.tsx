...
function SettingsLayout() {
	...
	return (
		<div className="col-form flex flex-col gap-6 sm:gap-8">
			<AppBreadcrumb
				parent={{ label: "All groups", to: "/app" }}
				page="Settings"
			/>
			<header className="rise-in flex min-w-0 flex-col gap-2">
			...
			<Tabs value={active} activationMode="manual">
				<TabsList className="segmented rail h-auto w-fit max-w-full justify-start p-1 [&>*]:shrink-0 [&>*]:px-4">
					{TABS.map((tab) => (
